...
#define HID_USAGE_POINTER               0x09, 0x01 /* Usage: Pointer */
#define HID_USAGE_MOUSE                 0x09, 0x02 /* Usage: Mouse */
#define HID_USAGE_KEYBOARD              0x09, 0x06 /* Usage: Keyboard */
#define HID_USAGE_X                     0x09, 0x30 /* Usage: X */
#define HID_USAGE_Y                     0x09, 0x31 /* Usage: Y */
#define HID_USAGE_Z                     0x09, 0x32 /* Usage: Z */
#define HID_USAGE_WHEEL                 0x09, 0x38 /* Usage: Wheel */
#define HID_USAGE_MOTION_WAKEUP         0x09, 0x3c /* Usage: Motion Wakeup */
